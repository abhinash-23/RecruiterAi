...
/**
 * Pass `indeterminate` for a "some, but not all" select-all: it draws a dash
 * instead of a tick. A tick over a partial selection claims the whole list is
 * selected, which is the one thing the control exists to communicate.
 */
